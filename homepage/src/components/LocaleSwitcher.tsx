...
/**
 * Site-wide UI language switcher, rendered in the footer.
 *
 * Opens upward (it lives at the bottom of the page) and lets the visitor pick
 * between the supported locales. The choice is persisted and overrides the
  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left">
      <button
        ...
        className={clsxm(
          'inline-flex items-center gap-1.5 rounded-full border border-current/30 px-3 py-1.5',
          'text-xs font-medium text-current transition-colors duration-200',
